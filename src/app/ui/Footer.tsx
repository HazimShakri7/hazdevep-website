export default function Footer() {
  return (
    <footer id="footer" className="relative bg-gradient-to-r from-black to-green-900 text-white shadow-md border-t-2 border-transparent pt-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 border-t-2 border-white p-12">
