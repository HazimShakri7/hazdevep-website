  ...
  return (
    <div className="max-w-6xl mx-auto mt-8 px-4">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-left mt-4">
        ...
        <div className="col-span-1 sm:col-span-2 md:col-span-4 mt-2 flex items-center">
          ...
          <label htmlFor="privacyPolicy" className="text-white">
            By ticking this box, I agree to the <a href="/privacy-policy" className="text-yellow-500 underline">Privacy Policy</a>
          </label>
        </div>
